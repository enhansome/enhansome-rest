...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/graph/GuidelinesGraph.md) ⭐ 23,319 | 🐛 176 | 📅 2026-08-05 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,670 | 🐛 5,707 | 🌐 Java | 📅 2026-08-14 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 27,597 | 🐛 388 | 🌐 Haskell | 📅 2026-08-13 - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,687 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-13 - Framework specifically meant for REST API.
...
* [Fusio](https://github.com/apioo/fusio) ⭐ 2,111 | 🐛 170 | 🌐 PHP | 📅 2026-07-30 - Open source API management platform.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,569 | 🐛 273 | 🌐 PHP | 📅 2026-08-01 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,362 | 🐛 59 | 🌐 PHP | 📅 2026-08-12 - Generate documentation for your REST API from annotations.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,055 | 🐛 97 | 🌐 PowerShell | 📅 2026-08-13 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,605 | 🐛 73 | 🌐 Python | 📅 2026-08-14 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,796 | 🐛 159 | 🌐 Python | 📅 2026-07-31 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,578 | 🐛 35 | 🌐 Java | 📅 2026-08-13 - A framework for developing ops-friendly, high-performance, RESTful web services.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,944 | 🐛 886 | 🌐 TypeScript | 📅 2026-08-14 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,419 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,450 | 🐛 472 | 🌐 C | 📅 2026-08-12 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,139 | 🐛 592 | 🌐 Java | 📅 2026-07-22 - Java DSL for easy testing of REST services.
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,526 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,701 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 - Serve a REST API from fixture files using quick prototyping.
...
* [Request Baskets](https://github.com/darklynx/request-baskets) ⭐ 428 | 🐛 18 | 🌐 Go | 📅 2024-06-27 - Service to collect HTTP requests and inspect them via RESTful API or web UI.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,877 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-11 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 43,984 | 🐛 188 | 🌐 Lua | 📅 2026-08-04 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,792 | 🐛 488 | 🌐 Go | 📅 2026-08-14 - Lightweight API gateway with analytics logging, written in Go.
* [Lura](https://github.com/luraproject/lura) ⭐ 6,787 | 🐛 13 | 🌐 Go | 📅 2026-08-04 - Ultra performant API Gateway with middleware. Written in Go.
* [Express Gateway](https://github.com/ExpressGateway/express-gateway) ⭐ 3,033 | 🐛 78 | 🌐 JavaScript | 📅 2024-05-14 - Microservices API Gateway built on top of ExpressJS (Node.js).
...
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 1,017 | 🐛 654 | 🌐 Java | 📅 2026-08-12 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,453 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-14 - Native integrations framework to consume REST APIs (open-source).
...
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,778 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-04 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
