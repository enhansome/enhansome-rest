...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,570 | 🐛 262 | 🌐 PHP | 📅 2026-08-16 - Build a REST API which follow Hydra/JSON-LD specification.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,055 | 🐛 100 | 🌐 PowerShell | 📅 2026-08-17 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,956 | 🐛 864 | 🌐 TypeScript | 📅 2026-08-19 - Cross-platform HTTP and GraphQL Client
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,539 | 🐛 9 | 🌐 Python | 📅 2026-08-19 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 1,019 | 🐛 655 | 🌐 Java | 📅 2026-08-19 - API management tool with lightweight gateway and API lifecycle management, written in Java.
