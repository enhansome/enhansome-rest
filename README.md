...
* [API-Security-Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,318 | 🐛 2 | 📅 2026-07-21 - Best practices about REST API security
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/graph/GuidelinesGraph.md) ⭐ 23,334 | 🐛 179 | 📅 2026-08-05 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
* [Restful API Guidelines by Zalando](https://github.com/zalando/restful-api-guidelines) ⭐ 3,247 | 🐛 14 | 🌐 CSS | 📅 2026-07-08 - Developing Restful APIs: A Comprehensive Set of Guidelines.
...
* [JSend](https://github.com/omniti-labs/jsend) ⭐ 1,724 | 🐛 9 | 📅 2022-01-21 - Simple specification that lays down some rules for how JSON responses from web servers should be formatted.
...
* [unirest for PHP](https://github.com/Mashape/unirest-php) ⭐ 1,278 | 🐛 41 | 🌐 PHP | 📅 2025-04-14 - Simplified, lightweight HTTP client library.
* [Guzzle](https://guzzle.readthedocs.org/en/latest/) - HTTP client and framework for consuming RESTful web services.

### JavaScript Clients

* [restangular](https://github.com/mgonto/restangular) ⭐ 7,786 | 🐛 253 | 🌐 JavaScript | 📅 2020-10-05 - AngularJS service to handle REST API properly and easily.
* [restful.js](https://github.com/marmelab/restful.js) ⚠️ Archived - JS client for interacting with server-side RESTful resources.
* [traverson](https://github.com/basti1302/traverson) ⭐ 461 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-15 - A Hypermedia API/HATEOAS Client for Node.js and the Browser
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,804 | 🐛 20 | 🌐 Go | 📅 2026-09-07 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [RestEase](https://github.com/canton7/RestEase) ⭐ 1,115 | 🐛 15 | 🌐 C# | 📅 2023-12-10 - Easy-to-use typesafe REST API client library, which is simple and customisable. Heavily inspired by Refit
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,745 | 🐛 5,746 | 🌐 Java | 📅 2026-09-17 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 27,670 | 🐛 401 | 🌐 Haskell | 📅 2026-09-17 - Serve a fully RESTful API directly from an existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,618 | 🐛 153 | 🌐 Go | 📅 2026-09-17 - A fully RESTful API from any existing PostgreSQL database written in Go.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,687 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-04 - Framework specifically meant for REST API.
* [Nestjsx/crud](https://github.com/nestjsx/crud) ⭐ 4,323 | 🐛 290 | 🌐 TypeScript | 📅 2026-09-08 - Generate CRUD controllers and services for RESTful API with NestJS and TypeORM.
...
* [Expressa](https://github.com/thomas4019/expressa) ⭐ 452 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-17 - Express middleware for creating APIs from JSON schemas with a simple admin editor and permissions model.
...
* [Fusio](https://github.com/apioo/fusio) ⭐ 2,116 | 🐛 169 | 🌐 PHP | 📅 2026-09-06 - Open source API management platform.
* [Negotiation](https://github.com/willdurand/Negotiation) ⭐ 1,420 | 🐛 11 | 🌐 PHP | 📅 2023-08-03 - Content negotiation library.
* [Restler](https://github.com/Luracast/Restler) ⭐ 1,383 | 🐛 33 | 🌐 PHP | 📅 2026-08-22 - Lightweight framework to expose PHP methods as RESTful web API.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,185 | 🐛 3 | 🌐 PHP | 📅 2026-09-01 - Specialize Symfony edition for the creation of hypermedia REST APIs.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 243 | 🌐 PHP | 📅 2026-09-17 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,368 | 🐛 56 | 🌐 PHP | 📅 2026-09-14 - Generate documentation for your REST API from annotations.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,062 | 🐛 90 | 🌐 PowerShell | 📅 2026-09-14 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,398 | 🐛 80 | 🌐 Python | 📅 2026-09-14 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,800 | 🐛 159 | 🌐 Python | 📅 2026-09-17 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,014 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,580 | 🐛 50 | 🌐 Java | 📅 2026-09-16 - A framework for developing ops-friendly, high-performance, RESTful web services.
* [Vertx-Web](https://github.com/vert-x3/vertx-web) ⭐ 1,150 | 🐛 150 | 🌐 Java | 📅 2026-09-16 - Vert.x-Web is a set of building blocks for building web applications with Vert.x, a toolkit for building reactive applications on the JVM.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 40,020 | 🐛 885 | 🌐 TypeScript | 📅 2026-09-17 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,525 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
...
* [HTTP Prompt](https://github.com/eliangcs/http-prompt) ⭐ 9,109 | 🐛 56 | 🌐 Python | 📅 2024-05-21 - HTTP Prompt is an interactive command-line HTTP client featuring autocomplete and syntax highlighting, built on HTTPie and prompt\_toolkit.
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,607 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [Milkman](https://github.com/warmuuh/milkman) ⭐ 1,338 | 🐛 13 | 🌐 Java | 📅 2026-09-17 - Extensible cross-platform request/response workbench, not only for http calls.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,709 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 - Serve a REST API from fixture files using quick prototyping.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,913 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-16 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,147 | 🐛 200 | 🌐 Lua | 📅 2026-09-07 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,822 | 🐛 508 | 🌐 Go | 📅 2026-09-17 - Lightweight API gateway with analytics logging, written in Go.
* [Lura](https://github.com/luraproject/lura) ⭐ 6,796 | 🐛 13 | 🌐 Go | 📅 2026-09-02 - Ultra performant API Gateway with middleware. Written in Go.
...
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 1,028 | 🐛 651 | 🌐 Java | 📅 2026-09-11 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 12,226 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-17 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,936 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-17 - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,788 | 🐛 3,445 | 🌐 Mustache | 📅 2026-08-18 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
...
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 1,098 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
