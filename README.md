...
* [API-Security-Checklist](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,300 | 🐛 2 | 📅 2026-07-21 - Best practices about REST API security
* [HTTP API design guide extracted from work on the Heroku Platform API](https://github.com/interagent/http-api-design) ⭐ 13,686 | 🐛 30 | 📅 2024-01-16
...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/graph/GuidelinesGraph.md) ⭐ 23,318 | 🐛 176 | 📅 2026-08-05 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
* [Restful API Guidelines by Zalando](https://github.com/zalando/restful-api-guidelines) ⭐ 3,226 | 🐛 15 | 🌐 CSS | 📅 2026-07-08 - Developing Restful APIs: A Comprehensive Set of Guidelines.
...
* [Haufe API Style Guide](https://github.com/Haufe-Lexware/api-style-guide) ⭐ 245 | 🐛 21 | 📅 2023-07-20 - Guidelines created by Haufe-Lexware CTO team.
...
* [Buzz](https://github.com/kriswallsmith/buzz) ⭐ 1,916 | 🐛 9 | 🌐 PHP | 📅 2026-05-15 - Another lightweight HTTP client.
...
* [restangular](https://github.com/mgonto/restangular) ⭐ 7,792 | 🐛 253 | 🌐 JavaScript | 📅 2020-10-05 - AngularJS service to handle REST API properly and easily.
* [restful.js](https://github.com/marmelab/restful.js) ⚠️ Archived - JS client for interacting with server-side RESTful resources.
* [traverson](https://github.com/basti1302/traverson) ⭐ 461 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-12 - A Hypermedia API/HATEOAS Client for Node.js and the Browser
* [raml-client-generator](https://github.com/mulesoft/raml-client-generator) ⚠️ Archived - Generates static client libs for js.

### Node.js Clients

* [restler](https://github.com/danwrong/restler) ⭐ 1,978 | 🐛 102 | 🌐 JavaScript | 📅 2019-07-10 - REST client library for node.js.
...
* [Refit](https://github.com/reactiveui/refit) ⭐ 9,558 | 🐛 3 | 🌐 C# | 📅 2026-08-13 - The automatic type-safe REST library for Xamarin and .NET
* [RestEase](https://github.com/canton7/RestEase) ⭐ 1,117 | 🐛 15 | 🌐 C# | 📅 2023-12-10 - Easy-to-use typesafe REST API client library, which is simple and customisable. Heavily inspired by Refit
* [Tiny.RestClient](https://github.com/jgiacomini/Tiny.RestClient) ⭐ 209 | 🐛 16 | 🌐 C# | 📅 2026-07-17 - Simpliest Fluent REST client for .NET.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,667 | 🐛 5,706 | 🌐 Java | 📅 2026-08-13 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 27,596 | 🐛 387 | 🌐 Haskell | 📅 2026-08-13 - Serve a fully RESTful API directly from an existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,610 | 🐛 151 | 🌐 Go | 📅 2026-08-11 - A fully RESTful API from any existing PostgreSQL database written in Go.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,686 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-13 - Framework specifically meant for REST API.
* [Nestjsx/crud](https://github.com/nestjsx/crud) ⭐ 4,325 | 🐛 290 | 🌐 TypeScript | 📅 2024-07-16 - Generate CRUD controllers and services for RESTful API with NestJS and TypeORM.
...
* [Expressa](https://github.com/thomas4019/expressa) ⭐ 452 | 🐛 22 | 🌐 JavaScript | 📅 2026-04-05 - Express middleware for creating APIs from JSON schemas with a simple admin editor and permissions model.
...
* [Fusio](https://github.com/apioo/fusio) ⭐ 2,112 | 🐛 170 | 🌐 PHP | 📅 2026-07-30 - Open source API management platform.
* [Negotiation](https://github.com/willdurand/Negotiation) ⭐ 1,419 | 🐛 11 | 🌐 PHP | 📅 2023-08-03 - Content negotiation library.
* [Restler](https://github.com/Luracast/Restler) ⭐ 1,382 | 🐛 32 | 🌐 PHP | 📅 2026-06-29 - Lightweight framework to expose PHP methods as RESTful web API.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,175 | 🐛 11 | 🌐 PHP | 📅 2026-08-01 - Specialize Symfony edition for the creation of hypermedia REST APIs.
* [FOSRestBundle](https://github.com/FriendsOfSymfony/FOSRestBundle) ⭐ 2,796 | 🐛 159 | 🌐 PHP | 📅 2026-02-10 - Bundle handling view, routing, error handling, etc. for your REST API.
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,568 | 🐛 270 | 🌐 PHP | 📅 2026-08-01 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,361 | 🐛 59 | 🌐 PHP | 📅 2026-08-12 - Generate documentation for your REST API from annotations.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,055 | 🐛 97 | 🌐 PowerShell | 📅 2026-08-07 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,570 | 🐛 73 | 🌐 Python | 📅 2026-08-12 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
* [Falcon](https://github.com/falconry/falcon) ⭐ 9,795 | 🐛 159 | 🌐 Python | 📅 2026-07-31 - Falcon is a bare-metal Python web API framework for building high-performance microservices, app backends, and higher-level frameworks.
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,012 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,579 | 🐛 35 | 🌐 Java | 📅 2026-08-13 - A framework for developing ops-friendly, high-performance, RESTful web services.
* [Vertx-Web](https://github.com/vert-x3/vertx-web) ⭐ 1,151 | 🐛 150 | 🌐 Java | 📅 2026-08-10 - Vert.x-Web is a set of building blocks for building web applications with Vert.x, a toolkit for building reactive applications on the JVM.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,941 | 🐛 884 | 🌐 TypeScript | 📅 2026-08-13 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,416 | 🐛 328 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,448 | 🐛 472 | 🌐 C | 📅 2026-08-12 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,141 | 🐛 592 | 🌐 Java | 📅 2026-07-22 - Java DSL for easy testing of REST services.
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,520 | 🐛 9 | 🌐 Python | 📅 2026-08-13 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [Http-console](https://github.com/cloudhead/http-console) ⭐ 1,393 | 🐛 14 | 🌐 JavaScript | 📅 2021-06-07 - Command line interface for HTTP that let you *speak HTTP like a local*
* [Milkman](https://github.com/warmuuh/milkman) ⭐ 1,340 | 🐛 16 | 🌐 Java | 📅 2026-08-04 - Extensible cross-platform request/response workbench, not only for http calls.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,699 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 - Serve a REST API from fixture files using quick prototyping.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,873 | 🐛 451 | 🌐 TypeScript | 📅 2026-08-11 - OpenAPI/Swagger-powered three-panel documentation.
...
* [raml2html](https://github.com/raml2html/raml2html) ⭐ 1,132 | 🐛 27 | 🌐 JavaScript | 📅 2022-09-22 - Generates HTML documentation from a RAML file.
...
* [Kong](https://github.com/Kong/kong) ⭐ 43,974 | 🐛 188 | 🌐 Lua | 📅 2026-08-04 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,792 | 🐛 485 | 🌐 Go | 📅 2026-08-13 - Lightweight API gateway with analytics logging, written in Go.
* [Lura](https://github.com/luraproject/lura) ⭐ 6,787 | 🐛 13 | 🌐 Go | 📅 2026-08-04 - Ultra performant API Gateway with middleware. Written in Go.
* [Express Gateway](https://github.com/ExpressGateway/express-gateway) ⭐ 3,034 | 🐛 78 | 🌐 JavaScript | 📅 2024-05-14 - Microservices API Gateway built on top of ExpressJS (Node.js).
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,194 | 🐛 259 | 🌐 Ruby | 📅 2026-08-12 - API management platform for exposing web services, with web interface and analytics, written in Lua.
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 1,015 | 🐛 654 | 🌐 Java | 📅 2026-08-12 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,439 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-13 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,889 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-09 - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,781 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-04 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
* [ng-admin](https://github.com/marmelab/ng-admin) ⭐ 3,903 | 🐛 111 | 🌐 JavaScript | 📅 2020-06-01 - Add an AngularJS admin GUI to any RESTful API.
* [shadcn-admin-kit](https://github.com/marmelab/shadcn-admin-kit) ⭐ 1,068 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-03 - Build internal tools, admin panels, B2B apps, and dashboards on top of any REST API
