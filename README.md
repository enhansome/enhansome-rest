...
* [Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/graph/GuidelinesGraph.md) ⭐ 23,336 | 🐛 176 | 📅 2026-08-05 - The Microsoft REST API Guidelines, as a design principle, encourages application developers to have resources accessible to them via a RESTful HTTP interface.
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,711 | 🐛 5,725 | 🌐 Java | 📅 2026-08-31 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 27,637 | 🐛 397 | 🌐 Haskell | 📅 2026-08-30 - Serve a fully RESTful API directly from an existing PostgreSQL database.
* [pREST](https://github.com/prest/prest) ⭐ 4,613 | 🐛 153 | 🌐 Go | 📅 2026-08-28 - A fully RESTful API from any existing PostgreSQL database written in Go.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,687 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-31 - Framework specifically meant for REST API.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,057 | 🐛 85 | 🌐 PowerShell | 📅 2026-08-29 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,974 | 🐛 80 | 🌐 Python | 📅 2026-08-26 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,577 | 🐛 46 | 🌐 Java | 📅 2026-08-31 - A framework for developing ops-friendly, high-performance, RESTful web services.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,965 | 🐛 868 | 🌐 TypeScript | 📅 2026-08-31 - Cross-platform HTTP and GraphQL Client
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,523 | 🐛 474 | 🌐 C | 📅 2026-08-23 - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,571 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,894 | 🐛 449 | 🌐 TypeScript | 📅 2026-08-20 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,063 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,810 | 🐛 499 | 🌐 Go | 📅 2026-08-31 - Lightweight API gateway with analytics logging, written in Go.
* [Lura](https://github.com/luraproject/lura) ⭐ 6,793 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - Ultra performant API Gateway with middleware. Written in Go.
...
* [API Umbrella](https://github.com/NREL/api-umbrella) ⭐ 2,196 | 🐛 256 | 🌐 Ruby | 📅 2026-08-29 - API management platform for exposing web services, with web interface and analytics, written in Lua.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,652 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-31 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,916 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-31 - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen](https://github.com/swagger-api/swagger-codegen) ⭐ 17,783 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-18 - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
