...
* [Restful API Guidelines by Zalando](https://github.com/zalando/restful-api-guidelines) ⭐ 3,241 | 🐛 14 | 🌐 CSS | 📅 2026-07-08 - Developing Restful APIs: A Comprehensive Set of Guidelines.
...
* [restangular](https://github.com/mgonto/restangular) ⭐ 7,787 | 🐛 253 | 🌐 JavaScript | 📅 2020-10-05 - AngularJS service to handle REST API properly and easily.
* [restful.js](https://github.com/marmelab/restful.js) ⚠️ Archived - JS client for interacting with server-side RESTful resources.
* [traverson](https://github.com/basti1302/traverson) ⭐ 461 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-02 - A Hypermedia API/HATEOAS Client for Node.js and the Browser
...
* [resty](https://github.com/go-resty/resty) ⭐ 11,772 | 🐛 23 | 🌐 Go | 📅 2026-07-26 - Simple HTTP and REST client for Go inspired by Ruby rest-client.
* [gopencils](https://github.com/bndr/gopencils) ⭐ 453 | 🐛 8 | 🌐 Go | 📅 2019-02-18 - Small and simple package to easily consume REST APIs.

### .NET Clients

* [RestSharp](https://github.com/restsharp/RestSharp) ⭐ 9,825 | 🐛 34 | 🌐 C# | 📅 2026-09-02 - Simple REST and HTTP API client for .NET
...
* [openapi-generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,721 | 🐛 5,726 | 🌐 Java | 📅 2026-09-03 - OpenAPI Generator allows generation of API client libraries (SDK generation), server stubs, documentation and configuration automatically given an OpenAPI Spec (v2, v3).

## Servers

### Directly On Top Of A RMDB

* [postgrest](https://github.com/begriffs/postgrest) ⭐ 27,639 | 🐛 399 | 🌐 Haskell | 📅 2026-09-03 - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [node-restify](https://github.com/restify/node-restify) ⭐ 10,687 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-03 - Framework specifically meant for REST API.
...
* [API Platform](https://github.com/api-platform/api-platform) ⭐ 9,182 | 🐛 2 | 🌐 PHP | 📅 2026-09-01 - Specialize Symfony edition for the creation of hypermedia REST APIs.
...
* [DunglasApiBundle](https://github.com/dunglas/DunglasApiBundle) ⭐ 2,574 | 🐛 266 | 🌐 PHP | 📅 2026-09-02 - Build a REST API which follow Hydra/JSON-LD specification.
* [NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) ⭐ 2,366 | 🐛 51 | 🌐 PHP | 📅 2026-09-03 - Generate documentation for your REST API from annotations.
...
* [Pode](https://github.com/Badgerati/Pode) ⭐ 1,057 | 🐛 89 | 🌐 PowerShell | 📅 2026-09-01 - Pode is an cross-platform, open-source, community-supported web server and REST API framework for PowerShell developers

### Python

* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,058 | 🐛 81 | 🌐 Python | 📅 2026-09-01 - FastAPI is a modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints. With automatic API documentation using Swagger UI and ReDoc, based on OpenAPI and JSON Schema.
...
* [Zato](https://github.com/zatosource/zato/) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - Platform for building server-side integrations, automations and API backends in Python.
...
* [Dropwizard](https://github.com/dropwizard/dropwizard) ⭐ 8,577 | 🐛 48 | 🌐 Java | 📅 2026-09-03 - A framework for developing ops-friendly, high-performance, RESTful web services.
...
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,983 | 🐛 872 | 🌐 TypeScript | 📅 2026-09-03 - Cross-platform HTTP and GraphQL Client
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,478 | 🐛 335 | 🌐 Python | 📅 2024-12-17 - Command line HTTP client, far more dev-friendly than `curl`.
...
* [rest-assured](https://github.com/rest-assured/rest-assured) ⭐ 7,141 | 🐛 593 | 🌐 Java | 📅 2026-07-22 - Java DSL for easy testing of REST services.
* [Schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,577 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Property-based testing tool for web applications built with Open API and GraphQL specifications.
...
* [ReDoc](https://github.com/Rebilly/ReDoc/) ⭐ 25,899 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-03 - OpenAPI/Swagger-powered three-panel documentation.
...
* [Kong](https://github.com/Kong/kong) ⭐ 44,080 | 🐛 194 | 🌐 Lua | 📅 2026-09-03 - Scalable, distributed, and plugin oriented API gateway backed by Nginx.
* [Tyk API Gateway](https://github.com/TykTechnologies/tyk) ⭐ 10,813 | 🐛 499 | 🌐 Go | 📅 2026-09-03 - Lightweight API gateway with analytics logging, written in Go.
...
* [WSO2 API Management](https://github.com/wso2/product-apim) ⭐ 1,024 | 🐛 651 | 🌐 Java | 📅 2026-09-03 - API management tool with lightweight gateway and API lifecycle management, written in Java.
...
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,691 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-03 - Native integrations framework to consume REST APIs (open-source).
...
* [react-admin](https://github.com/marmelab/react-admin) ⭐ 26,917 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-03 - Add a ReactJS admin GUI to any RESTful API.
